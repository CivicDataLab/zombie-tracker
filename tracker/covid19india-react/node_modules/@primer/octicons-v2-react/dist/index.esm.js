...
function CircleIcon(props) {
  var svgDataByHeight = { "24": { "width": 24, "path": "<path fill-rule=\"evenodd\" d=\"M12 2.5a9.5 9.5 0 100 19 9.5 9.5 0 000-19zM1 12C1 5.925 5.925 1 12 1s11 4.925 11 11-4.925 11-11 11S1 18.075 1 12z\"></path>" } };
  return React.createElement('svg', getSvgProps(_extends({}, props, { svgDataByHeight: svgDataByHeight })));
}
...
function DotIcon(props) {
  var svgDataByHeight = { "16": { "width": 16, "path": "<path fill-rule=\"evenodd\" d=\"M8 11.5a3.5 3.5 0 100-7 3.5 3.5 0 000 7zM8 13A5 5 0 108 3a5 5 0 000 10z\"></path>" }, "24": { "width": 24, "path": "<path fill-rule=\"evenodd\" d=\"M12 16.5a4.5 4.5 0 100-9 4.5 4.5 0 000 9zm0 1.5a6 6 0 100-12 6 6 0 000 12z\"></path>" } };
  return React.createElement('svg', getSvgProps(_extends({}, props, { svgDataByHeight: svgDataByHeight })));
}
...
function DotFillIcon(props) {
  var svgDataByHeight = { "16": { "width": 16, "path": "<path d=\"M8 13A5 5 0 108 3a5 5 0 000 10z\"></path>" }, "24": { "width": 24, "path": "<path d=\"M12 18a6 6 0 100-12 6 6 0 000 12z\"></path>" } };
  return React.createElement('svg', getSvgProps(_extends({}, props, { svgDataByHeight: svgDataByHeight })));
}
...
function TriangleDownIcon(props) {
  var svgDataByHeight = { "16": { "width": 16, "path": "<path d=\"M4.427 6.427l3.396 3.396a.25.25 0 00.354 0l3.396-3.396A.25.25 0 0011.396 6H4.604a.25.25 0 00-.177.427z\"></path>" }, "24": { "width": 24, "path": "<path d=\"M11.646 15.146L5.854 9.354a.5.5 0 01.353-.854h11.586a.5.5 0 01.353.854l-5.793 5.792a.5.5 0 01-.707 0z\"></path>" } };
  return React.createElement('svg', getSvgProps(_extends({}, props, { svgDataByHeight: svgDataByHeight })));
}
...
export { AlertIcon, ArchiveIcon, ArrowBothIcon, ArrowDownIcon, ArrowDownLeftIcon, ArrowDownRightIcon, ArrowLeftIcon, ArrowRightIcon, ArrowUpIcon, ArrowUpLeftIcon, ArrowUpRightIcon, BeakerIcon, BellIcon, BellFillIcon, BellSlashIcon, BoldIcon, BookIcon, BookmarkIcon, BookmarkFillIcon, BookmarkSlashIcon, BookmarkSlashFillIcon, BroadcastIcon, CalendarIcon, CheckIcon, CheckCircleIcon, CheckCircleFillIcon, ChecklistIcon, ChevronDownIcon, ChevronLeftIcon, ChevronRightIcon, ChevronUpIcon, CircleIcon, CircleSlashIcon, ClippyIcon, ClockIcon, CodeIcon, CodeReviewIcon, CodeSquareIcon, CommentIcon, CommentDiscussionIcon, CommitIcon, CopyIcon, CpuIcon, CreditCardIcon, CrossReferenceIcon, DashIcon, DatabaseIcon, DesktopDownloadIcon, DeviceCameraVideoIcon, DeviceDesktopIcon, DeviceMobileIcon, DiffIcon, DiffAddedIcon, DiffIgnoredIcon, DiffModifiedIcon, DiffRemovedIcon, DiffRenamedIcon, DotIcon, DotFillIcon, DownloadIcon, EyeIcon, EyeClosedIcon, EyeSlashIcon, FileIcon, FileBinaryIcon, FileCodeIcon, FileDiffIcon, FileDirectoryIcon, FileDirectoryFillIcon, FileMediaIcon, FileSubmoduleIcon, FileSymlinkIcon, FileSymlinkFileIcon, FileZipIcon, FilterIcon, FireIcon, FlameIcon, FoldIcon, FoldDownIcon, FoldUpIcon, GearIcon, GiftIcon, GitBranchIcon, GitCommitIcon, GitCompareIcon, GitForkIcon, GitMergeIcon, GitPullRequestIcon, GlobeIcon, GrabberIcon, GraphIcon, HeadingIcon, HeartIcon, HeartFillIcon, HistoryIcon, HomeIcon, HomeFillIcon, HorizontalRuleIcon, HourglassIcon, HubotIcon, ImageIcon, InboxIcon, InfinityIcon, InfoIcon, InsightsIcon, IssueClosedIcon, IssueOpenedIcon, IssueReopenedIcon, ItalicIcon, KebabHorizontalIcon, KeyIcon, LawIcon, LightBulbIcon, LinkIcon, LinkExternalIcon, ListOrderedIcon, ListUnorderedIcon, LocationIcon, LockIcon, LogoGistIcon, LogoGithubIcon, MailIcon, MarkGithubIcon, MarkdownIcon, MegaphoneIcon, MentionIcon, MilestoneIcon, MirrorIcon, MortarBoardIcon, MuteIcon, NoEntryIcon, NorthStarIcon, NoteIcon, OctofaceIcon, OrganizationIcon, PackageIcon, PackageDependenciesIcon, PackageDependentsIcon, PaperAirplaneIcon, PencilIcon, PeopleIcon, PersonIcon, PinIcon, PlayIcon, PlugIcon, PlusIcon, PlusCircleIcon, ProjectIcon, PulseIcon, QuestionIcon, QuoteIcon, ReplyIcon, RepoIcon, RepoForkedIcon, RepoPushIcon, RepoTemplateIcon, ReportIcon, RocketIcon, RssIcon, ScreenFullIcon, ScreenNormalIcon, SearchIcon, ServerIcon, SettingsIcon, ShareIcon, ShareAndroidIcon, ShieldIcon, ShieldCheckIcon, ShieldLockIcon, ShieldXIcon, SignInIcon, SignOutIcon, SkipIcon, SmileyIcon, StarIcon, StarFillIcon, StopIcon, StopwatchIcon, SyncIcon, TabIcon, TagIcon, TasklistIcon, TelescopeIcon, TerminalIcon, ThreeBarsIcon, ThumbsdownIcon, ThumbsupIcon, ToolsIcon, TrashIcon, TrashcanIcon, TriangleDownIcon, TriangleLeftIcon, TriangleRightIcon, TriangleUpIcon, TypographyIcon, UnfoldIcon, UnlockIcon, UnmuteIcon, UnverifedIcon, UnverifiedIcon, UploadIcon, VerifiedIcon, VersionsIcon, WorkflowIcon, XIcon, XCircleIcon, XCircleFillIcon };
