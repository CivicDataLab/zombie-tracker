...
export const STATISTIC_DEFINITIONS = {
  total: {
    displayName: 'total',
    ts_displayName: 'cases registered',
    table_displayName: 'total',
    color: '#ff073a', // 'd8cfc7#',
    format: 'int',
    options: {key: 'total'},
  },
  pending: {
    displayName: 'pending',
    ts_displayName: 'cases_pending_till_date',
    table_displayName: 'pending',
    color: '#28a745', //#007bff',
    format: 'int',
    options: {key: 'pending'},
    hideDelta: true,
  ...
  disposed: {
    ...
    ts_displayName: 'cases_disposed_till_date',
    table_displayName: 'disposed',
    color: '#f9b950', //#28a745',
    format: 'int',
  ...
  pending_agg: {
    ...
    ts_displayName: 'total_pendency_at_year_end',
    table_displayName: 'total_pendency_at_year_end',
    color: '#646f6f',
    format: 'int',
  ...
  pending_before: {
    ...
    table_displayName: 'earlier_cases',
    color: '#646f6f',
    format: 'int',
  ...
  disposed_yearly: {
    ...
    ts_displayName: 'disposed_cases',
    table_displayName: 'disposed_cases',
    color: '#646f6f',
    format: 'int',
