...
function TimeseriesExplorer({
  ...
  return (
	...
	<div style={{textAlign:'right', marginBottom: '1rem'}}>  
          <button className="btn btn-secondary" onClick={setline} style={chart == "line"? {background:'black', color:'white', width:'11rem', borderRadius:'20px'} : {width:'11rem', borderRadius:'20px'}}>Line Trend</button>
          <button className="btn btn-secondary" onClick={setbar} style={chart == "bar"? {background:'black', color:'white', width:'11rem', borderRadius:'20px'} : {width:'11rem', borderRadius:'20px'}}>Bar chart</button>
          <button className="btn btn-secondary" onClick={settable} style={chart == "table"? {background:'black', color:'white', width:'11rem', borderRadius:'20px'} : {width:'11rem', borderRadius:'20px'}}>Table</button>
        </div>
        </div>
      )}


      {(chart == "line") && isVisible && (
     ...
     {(chart == "bar") && isVisible && (
      ...
      {/*<div className="pills">
       ...
       {(chart == "table") && selectedTimeseries && (
