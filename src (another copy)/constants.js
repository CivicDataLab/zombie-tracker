...
export const STATISTIC_DEFINITIONS = {
  ...
  pending: {
    displayName: 'pending',
    ts_displayName: 'cases registered and still pending',
    color: '#28a745', //#007bff',
    format: 'int',
    options: {key: 'pending'},
    hideDelta: true,
  ...
  disposed: {
    ...
    ts_displayName: 'cases registered which are disposed',
    color: '#f9b950', //#28a745',
    format: 'int',
  ...
  pending_agg: {
    ...
    ts_displayName: 'total pending cases',
    color: '#646f6f',
    format: 'int',
